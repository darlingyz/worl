...
export default class App extends React.Component {
	...
	render() {
		...
		<dl>
			...
			<dd>
				<p>新建</p>
				<p className="busineWork">技术合同认定登记</p>
			</dd>
		</dl>
		...
		<dl>
			...
			<dd>
				<p>新建</p>
				<p className="busineWork">技术贸易资格证业务</p>
			</dd>
		</dl>
		<dl>
			<dt><img src="./../img/Group 112.png"/></dt>
			<dd>
				<p>新建</p>
				<p className="busineWork">技术转移业务</p>
			</dd>
		</dl>
		<dl>
			<dt><img src="./../img/Group 112.png"/></dt>
			<dd>
				<p>新建</p>
				<p className="busineWork">服务机构入驻管理</p>
			</dd>
		</dl>
		<dl>
			<dt><img src="./../img/Group 112.png"/></dt>
			<dd>
				<p>新建</p>
				<p className="busineWork">创客创业服务</p>
			</dd>
		</dl>
		<dl>
			<dt><img src="./../img/Group 112.png"/></dt>
			<dd>
				<p>新建</p>
				<p className="busineWork">项目申报咨询管理</p>
			</dd>
		</dl>
		<dl>
			<dt><img src="./../img/Group 112.png"/></dt>
			<dd>
				<p>新建</p>
				<p className="busineWork">科技创新券服务管理</p>
			</dd>
		</dl>		  
		</div>	
	...
	componentDidMount() {
		...
		$(".Nextone").on("click", function() {
			...
			$(".CustomList").find("li").first().remove(); //移除第一条数据						
